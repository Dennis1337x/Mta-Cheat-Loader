...
function WebUIManager:constructor()
	...
	function cmove(relX,relY,absX,absY) 
	...
	addEventHandler("onClientCursorMove", root,cmove)
	
	function mousewheel(button, state)
	...
	addEventHandler("onClientKey", root, mousewheel)
...
function WebUIManager:unregisterWindow(window)
	...
	removeEventHandler("onClientKey",root,mousewheel)
	removeEventHandler("onClientCursorMove",root,cmove)
